...
def scheduling_and_control(last_time_hours: float=14, demand_p1_kmol: float=1,demand_p2_kmol: float=1):
    # Data
    Infty=10 
    # ------------pyomo model------------------------------------------------
    #------------------------------------------------------------------------
    ...
    m.I=pe.Set(initialize=['Mix',
                           'R1','R1_2','R1_3','R1_4','R1_5','R1_6','R1_7',
                           'R2','R2_2','R2_3','R2_4','R2_5','R2_6','R2_7',
                           'R3','R3_2','R3_3','R3_4','R3_5','R3_6','R3_7',
                           'Sep','Pack1','Pack2'], doc='Set of tasks')
    m.I_R1=pe.Set(initialize=['R1','R1_2','R1_3','R1_4','R1_5','R1_6','R1_7'],within=m.I)
    m.I_R2=pe.Set(initialize=['R2','R2_2','R2_3','R2_4','R2_5','R2_6','R2_7'],within=m.I)
    m.I_R3=pe.Set(initialize=['R3','R3_2','R3_3','R3_4','R3_5','R3_6','R3_7'],within=m.I)
    ...
    _I_i_k_minus['R1_2','M2']=1
    _I_i_k_minus['R1_3','M2']=1
    _I_i_k_minus['R1_4','M2']=1
    _I_i_k_minus['R1_5','M2']=1
    _I_i_k_minus['R1_6','M2']=1
    _I_i_k_minus['R1_7','M2']=1
    _I_i_k_minus['R1','M3']=1
    _I_i_k_minus['R1_2','M3']=1
    _I_i_k_minus['R1_3','M3']=1
    _I_i_k_minus['R1_4','M3']=1
    _I_i_k_minus['R1_5','M3']=1
    _I_i_k_minus['R1_6','M3']=1
    _I_i_k_minus['R1_7','M3']=1

    _I_i_k_minus['R2','I1']=1
    _I_i_k_minus['R2_2','I1']=1
    _I_i_k_minus['R2_3','I1']=1
    _I_i_k_minus['R2_4','I1']=1
    _I_i_k_minus['R2_5','I1']=1
    _I_i_k_minus['R2_6','I1']=1
    _I_i_k_minus['R2_7','I1']=1
    _I_i_k_minus['R2','I2']=1
    _I_i_k_minus['R2_2','I2']=1
    _I_i_k_minus['R2_3','I2']=1
    _I_i_k_minus['R2_4','I2']=1
    _I_i_k_minus['R2_5','I2']=1
    _I_i_k_minus['R2_6','I2']=1
    _I_i_k_minus['R2_7','I2']=1

    _I_i_k_minus['R3','I3']=1
    _I_i_k_minus['R3_2','I3']=1
    _I_i_k_minus['R3_3','I3']=1
    _I_i_k_minus['R3_4','I3']=1
    _I_i_k_minus['R3_5','I3']=1
    _I_i_k_minus['R3_6','I3']=1
    _I_i_k_minus['R3_7','I3']=1
    _I_i_k_minus['R3','M3']=1
    _I_i_k_minus['R3_2','M3']=1
    _I_i_k_minus['R3_3','M3']=1
    _I_i_k_minus['R3_4','M3']=1
    _I_i_k_minus['R3_5','M3']=1
    _I_i_k_minus['R3_6','M3']=1
    _I_i_k_minus['R3_7','M3']=1
    ...
    _I_i_k_plus['R1','I2']=1
    _I_i_k_plus['R1_2','I2']=1
    _I_i_k_plus['R1_3','I2']=1
    _I_i_k_plus['R1_4','I2']=1
    _I_i_k_plus['R1_5','I2']=1
    _I_i_k_plus['R1_6','I2']=1
    _I_i_k_plus['R1_7','I2']=1

    _I_i_k_plus['R2','I3']=1
    _I_i_k_plus['R2_2','I3']=1
    _I_i_k_plus['R2_3','I3']=1
    _I_i_k_plus['R2_4','I3']=1
    _I_i_k_plus['R2_5','I3']=1
    _I_i_k_plus['R2_6','I3']=1
    _I_i_k_plus['R2_7','I3']=1
    _I_i_k_plus['R2','I5']=1
    _I_i_k_plus['R2_2','I5']=1
    _I_i_k_plus['R2_3','I5']=1
    _I_i_k_plus['R2_4','I5']=1
    _I_i_k_plus['R2_5','I5']=1
    _I_i_k_plus['R2_6','I5']=1
    _I_i_k_plus['R2_7','I5']=1

    _I_i_k_plus['R3','I4']=1
    _I_i_k_plus['R3_2','I4']=1
    _I_i_k_plus['R3_3','I4']=1
    _I_i_k_plus['R3_4','I4']=1
    _I_i_k_plus['R3_5','I4']=1
    _I_i_k_plus['R3_6','I4']=1
    _I_i_k_plus['R3_7','I4']=1
    ...
    _rho_minus['R1_2','M2']=1/2
    _rho_minus['R1_3','M2']=1/2
    _rho_minus['R1_4','M2']=1/2
    _rho_minus['R1_5','M2']=1/2
    _rho_minus['R1_6','M2']=1/2
    _rho_minus['R1_7','M2']=1/2
    _rho_minus['R1','M3']=1/2
    _rho_minus['R1_2','M3']=1/2
    _rho_minus['R1_3','M3']=1/2
    _rho_minus['R1_4','M3']=1/2
    _rho_minus['R1_5','M3']=1/2
    _rho_minus['R1_6','M3']=1/2
    _rho_minus['R1_7','M3']=1/2

    _rho_minus['R2','I1']=1/2
    _rho_minus['R2_2','I1']=1/2
    _rho_minus['R2_3','I1']=1/2
    _rho_minus['R2_4','I1']=1/2
    _rho_minus['R2_5','I1']=1/2
    _rho_minus['R2_6','I1']=1/2
    _rho_minus['R2_7','I1']=1/2
    _rho_minus['R2','I2']=1/2
    _rho_minus['R2_2','I2']=1/2
    _rho_minus['R2_3','I2']=1/2
    _rho_minus['R2_4','I2']=1/2
    _rho_minus['R2_5','I2']=1/2
    _rho_minus['R2_6','I2']=1/2
    _rho_minus['R2_7','I2']=1/2
    

    _rho_minus['R3','I3']=1/2
    _rho_minus['R3_2','I3']=1/2
    _rho_minus['R3_3','I3']=1/2
    _rho_minus['R3_4','I3']=1/2
    _rho_minus['R3_5','I3']=1/2
    _rho_minus['R3_6','I3']=1/2
    _rho_minus['R3_7','I3']=1/2
    _rho_minus['R3','M3']=1/2
    _rho_minus['R3_2','M3']=1/2
    _rho_minus['R3_3','M3']=1/2
    _rho_minus['R3_4','M3']=1/2
    _rho_minus['R3_5','M3']=1/2
    _rho_minus['R3_6','M3']=1/2
    _rho_minus['R3_7','M3']=1/2
    ...
    _rho_plus['R2','I3']=3/5
    _rho_plus['R2_2','I3']=3/5
    _rho_plus['R2_3','I3']=3/5
    _rho_plus['R2_4','I3']=3/5
    _rho_plus['R2_5','I3']=3/5
    _rho_plus['R2_6','I3']=3/5
    _rho_plus['R2_7','I3']=3/5
    _rho_plus['R2','I5']=2/5
    _rho_plus['R2_2','I5']=2/5
    _rho_plus['R2_3','I5']=2/5
    _rho_plus['R2_4','I5']=2/5
    _rho_plus['R2_5','I5']=2/5
    _rho_plus['R2_6','I5']=2/5
    _rho_plus['R2_7','I5']=2/5
    ...
    _I_i_j_prod['R1_2','R_large']=1
    _I_i_j_prod['R1_3','R_large']=1
    _I_i_j_prod['R1_4','R_large']=1
    _I_i_j_prod['R1_5','R_large']=1
    _I_i_j_prod['R1_6','R_large']=1
    _I_i_j_prod['R1_7','R_large']=1
    _I_i_j_prod['R1','R_small']=1
    _I_i_j_prod['R1_2','R_small']=1
    _I_i_j_prod['R1_3','R_small']=1
    _I_i_j_prod['R1_4','R_small']=1
    _I_i_j_prod['R1_5','R_small']=1
    _I_i_j_prod['R1_6','R_small']=1
    _I_i_j_prod['R1_7','R_small']=1

    _I_i_j_prod['R2','R_large']=1
    _I_i_j_prod['R2_2','R_large']=1
    _I_i_j_prod['R2_3','R_large']=1
    _I_i_j_prod['R2_4','R_large']=1
    _I_i_j_prod['R2_5','R_large']=1
    _I_i_j_prod['R2_6','R_large']=1
    _I_i_j_prod['R2_7','R_large']=1
    _I_i_j_prod['R2','R_small']=1
    _I_i_j_prod['R2_2','R_small']=1
    _I_i_j_prod['R2_3','R_small']=1
    _I_i_j_prod['R2_4','R_small']=1
    _I_i_j_prod['R2_5','R_small']=1
    _I_i_j_prod['R2_6','R_small']=1
    _I_i_j_prod['R2_7','R_small']=1

    _I_i_j_prod['R3','R_large']=1
    _I_i_j_prod['R3_2','R_large']=1
    _I_i_j_prod['R3_3','R_large']=1
    _I_i_j_prod['R3_4','R_large']=1
    _I_i_j_prod['R3_5','R_large']=1
    _I_i_j_prod['R3_6','R_large']=1
    _I_i_j_prod['R3_7','R_large']=1
    _I_i_j_prod['R3','R_small']=1
    _I_i_j_prod['R3_2','R_small']=1
    _I_i_j_prod['R3_3','R_small']=1
    _I_i_j_prod['R3_4','R_small']=1
    _I_i_j_prod['R3_5','R_small']=1
    _I_i_j_prod['R3_6','R_small']=1
    _I_i_j_prod['R3_7','R_small']=1
    ...
    _beta_min['R1_2','R_large']=0.15
    _beta_min['R1_3','R_large']=0.15
    _beta_min['R1_4','R_large']=0.15
    _beta_min['R1_5','R_large']=0.15
    _beta_min['R1_6','R_large']=0.15
    _beta_min['R1_7','R_large']=0.15
    _beta_min['R1','R_small']=0.1
    _beta_min['R1_2','R_small']=0.1
    _beta_min['R1_3','R_small']=0.1
    _beta_min['R1_4','R_small']=0.1
    _beta_min['R1_5','R_small']=0.1
    _beta_min['R1_6','R_small']=0.1
    _beta_min['R1_7','R_small']=0.1

    _beta_min['R2','R_large']=0.15
    _beta_min['R2_2','R_large']=0.15
    _beta_min['R2_3','R_large']=0.15
    _beta_min['R2_4','R_large']=0.15
    _beta_min['R2_5','R_large']=0.15
    _beta_min['R2_6','R_large']=0.15
    _beta_min['R2_7','R_large']=0.15
    _beta_min['R2','R_small']=0.1
    _beta_min['R2_2','R_small']=0.1
    _beta_min['R2_3','R_small']=0.1
    _beta_min['R2_4','R_small']=0.1
    _beta_min['R2_5','R_small']=0.1
    _beta_min['R2_6','R_small']=0.1
    _beta_min['R2_7','R_small']=0.1

    _beta_min['R3','R_large']=0.15
    _beta_min['R3_2','R_large']=0.15
    _beta_min['R3_3','R_large']=0.15
    _beta_min['R3_4','R_large']=0.15
    _beta_min['R3_5','R_large']=0.15
    _beta_min['R3_6','R_large']=0.15
    _beta_min['R3_7','R_large']=0.15
    _beta_min['R3','R_small']=0.1
    _beta_min['R3_2','R_small']=0.1
    _beta_min['R3_3','R_small']=0.1
    _beta_min['R3_4','R_small']=0.1
    _beta_min['R3_5','R_small']=0.1
    _beta_min['R3_6','R_small']=0.1
    _beta_min['R3_7','R_small']=0.1
    ...
    _beta_max['R1_2','R_large']=1.5
    _beta_max['R1_3','R_large']=1.5
    _beta_max['R1_4','R_large']=1.5
    _beta_max['R1_5','R_large']=1.5
    _beta_max['R1_6','R_large']=1.5
    _beta_max['R1_7','R_large']=1.5
    _beta_max['R1','R_small']=1
    _beta_max['R1_2','R_small']=1
    _beta_max['R1_3','R_small']=1
    _beta_max['R1_4','R_small']=1
    _beta_max['R1_5','R_small']=1
    _beta_max['R1_6','R_small']=1
    _beta_max['R1_7','R_small']=1

    _beta_max['R2','R_large']=1.5
    _beta_max['R2_2','R_large']=1.5
    _beta_max['R2_3','R_large']=1.5
    _beta_max['R2_4','R_large']=1.5
    _beta_max['R2_5','R_large']=1.5
    _beta_max['R2_6','R_large']=1.5
    _beta_max['R2_7','R_large']=1.5
    _beta_max['R2','R_small']=1
    _beta_max['R2_2','R_small']=1
    _beta_max['R2_3','R_small']=1
    _beta_max['R2_4','R_small']=1
    _beta_max['R2_5','R_small']=1
    _beta_max['R2_6','R_small']=1
    _beta_max['R2_7','R_small']=1

    _beta_max['R3','R_large']=1.5
    _beta_max['R3_2','R_large']=1.5
    _beta_max['R3_3','R_large']=1.5
    _beta_max['R3_4','R_large']=1.5
    _beta_max['R3_5','R_large']=1.5
    _beta_max['R3_6','R_large']=1.5
    _beta_max['R3_7','R_large']=1.5
    _beta_max['R3','R_small']=1
    _beta_max['R3_2','R_small']=1
    _beta_max['R3_3','R_small']=1
    _beta_max['R3_4','R_small']=1
    _beta_max['R3_5','R_small']=1
    _beta_max['R3_6','R_small']=1
    _beta_max['R3_7','R_small']=1
    ...
    _fixed_cost['R1_2','R_large']=30
    _fixed_cost['R1_3','R_large']=30
    _fixed_cost['R1_4','R_large']=30
    _fixed_cost['R1_5','R_large']=30
    _fixed_cost['R1_6','R_large']=30
    _fixed_cost['R1_7','R_large']=30
    _fixed_cost['R1','R_small']=20
    _fixed_cost['R1_2','R_small']=20
    _fixed_cost['R1_3','R_small']=20
    _fixed_cost['R1_4','R_small']=20
    _fixed_cost['R1_5','R_small']=20
    _fixed_cost['R1_6','R_small']=20
    _fixed_cost['R1_7','R_small']=20

    _fixed_cost['R2','R_large']=30
    _fixed_cost['R2_2','R_large']=30
    _fixed_cost['R2_3','R_large']=30
    _fixed_cost['R2_4','R_large']=30
    _fixed_cost['R2_5','R_large']=30
    _fixed_cost['R2_6','R_large']=30
    _fixed_cost['R2_7','R_large']=30
    _fixed_cost['R2','R_small']=20
    _fixed_cost['R2_2','R_small']=20
    _fixed_cost['R2_3','R_small']=20
    _fixed_cost['R2_4','R_small']=20
    _fixed_cost['R2_5','R_small']=20
    _fixed_cost['R2_6','R_small']=20
    _fixed_cost['R2_7','R_small']=20

    _fixed_cost['R3','R_large']=30
    _fixed_cost['R3_2','R_large']=30
    _fixed_cost['R3_3','R_large']=30
    _fixed_cost['R3_4','R_large']=30
    _fixed_cost['R3_5','R_large']=30
    _fixed_cost['R3_6','R_large']=30
    _fixed_cost['R3_7','R_large']=30
    _fixed_cost['R3','R_small']=20
    _fixed_cost['R3_2','R_small']=20
    _fixed_cost['R3_3','R_small']=20
    _fixed_cost['R3_4','R_small']=20
    _fixed_cost['R3_5','R_small']=20
    _fixed_cost['R3_6','R_small']=20
    _fixed_cost['R3_7','R_small']=20
    ...
    _tau_p['R1','R_large']=1
    _tau_p['R1_2','R_large']=1.5
    _tau_p['R1_3','R_large']=2
    _tau_p['R1_4','R_large']=2.5
    _tau_p['R1_5','R_large']=3
    _tau_p['R1_6','R_large']=3.5
    _tau_p['R1_7','R_large']=4
    _tau_p['R1','R_small']=1
    _tau_p['R1_2','R_small']=1.5
    _tau_p['R1_3','R_small']=2
    _tau_p['R1_4','R_small']=2.5
    _tau_p['R1_5','R_small']=3
    _tau_p['R1_6','R_small']=3.5
    _tau_p['R1_7','R_small']=4

    _tau_p['R2','R_large']=1
    _tau_p['R2_2','R_large']=1.5
    _tau_p['R2_3','R_large']=2
    _tau_p['R2_4','R_large']=2.5
    _tau_p['R2_5','R_large']=3
    _tau_p['R2_6','R_large']=3.5
    _tau_p['R2_7','R_large']=4
    _tau_p['R2','R_small']=1
    _tau_p['R2_2','R_small']=1.5
    _tau_p['R2_3','R_small']=2
    _tau_p['R2_4','R_small']=2.5
    _tau_p['R2_5','R_small']=3
    _tau_p['R2_6','R_small']=3.5
    _tau_p['R2_7','R_small']=4

    _tau_p['R3','R_large']=1
    _tau_p['R3_2','R_large']=1.5
    _tau_p['R3_3','R_large']=2
    _tau_p['R3_4','R_large']=2.5
    _tau_p['R3_5','R_large']=3
    _tau_p['R3_6','R_large']=3.5
    _tau_p['R3_7','R_large']=4
    _tau_p['R3','R_small']=1
    _tau_p['R3_2','R_small']=1.5
    _tau_p['R3_3','R_small']=2
    _tau_p['R3_4','R_small']=2.5
    _tau_p['R3_5','R_small']=3
    _tau_p['R3_6','R_small']=3.5
    _tau_p['R3_7','R_small']=4
    ...
    # # ----------Linking constraints-------------------------------------------
    #1) Reactor volumes
    def _linkingR1_1(m,I,J,T):
        return m.B[I,J,T]-m.Vreactor['R1',J] <= (m.beta_max[I,J]-m.beta_min[I,J])*(1-m.X[I,J,T])  
    m.linkingR1_1=pe.Constraint(m.I_R1,m.J_reactors,m.T,rule=_linkingR1_1,doc='Linking constraint to fuarantee that batch sizes agree with reactor volumes') 

    def _linkingR1_2(m,I,J,T):
        return -(m.B[I,J,T]-m.Vreactor['R1',J]) <= m.beta_max[I,J]*(1-m.X[I,J,T])  
    m.linkingR1_2=pe.Constraint(m.I_R1,m.J_reactors,m.T,rule=_linkingR1_2,doc='Linking constraint to fuarantee that batch sizes agree with reactor volumes') 
      
    def _linkingR2_1(m,I,J,T):
        return m.B[I,J,T]-m.Vreactor['R2',J] <= (m.beta_max[I,J]-m.beta_min[I,J])*(1-m.X[I,J,T])  
    m.linkingR2_1=pe.Constraint(m.I_R2,m.J_reactors,m.T,rule=_linkingR2_1,doc='Linking constraint to fuarantee that batch sizes agree with reactor volumes') 

    def _linkingR2_2(m,I,J,T):
        return -(m.B[I,J,T]-m.Vreactor['R2',J]) <= m.beta_max[I,J]*(1-m.X[I,J,T])  
    m.linkingR2_2=pe.Constraint(m.I_R2,m.J_reactors,m.T,rule=_linkingR2_2,doc='Linking constraint to fuarantee that batch sizes agree with reactor volumes') 

    def _linkingR3_1(m,I,J,T):
        return m.B[I,J,T]-m.Vreactor['R3',J] <= (m.beta_max[I,J]-m.beta_min[I,J])*(1-m.X[I,J,T])  
    m.linkingR3_1=pe.Constraint(m.I_R3,m.J_reactors,m.T,rule=_linkingR3_1,doc='Linking constraint to fuarantee that batch sizes agree with reactor volumes') 

    def _linkingR3_2(m,I,J,T):
        return -(m.B[I,J,T]-m.Vreactor['R3',J]) <= m.beta_max[I,J]*(1-m.X[I,J,T])  
    m.linkingR3_2=pe.Constraint(m.I_R3,m.J_reactors,m.T,rule=_linkingR3_2,doc='Linking constraint to fuarantee that batch sizes agree with reactor volumes') 

    #2) Processing times
    def _linkingR1_3(m,J,T):
        return m.varTime['R1',J] - sum(m.X[II,J,T]*m.tau_p[II,J]     for II in m.I_R1)<=4*(1-sum(m.X[II,J,T] for II in m.I_R1))
    m.linkingR1_3=pe.Constraint(m.J_reactors,m.T,rule=_linkingR1_3)

    def _linkingR1_4(m,J,T):
        return -(m.varTime['R1',J] - sum(m.X[II,J,T]*m.tau_p[II,J]     for II in m.I_R1))<=4*(1-sum(m.X[II,J,T] for II in m.I_R1))
    m.linkingR1_4=pe.Constraint(m.J_reactors,m.T,rule=_linkingR1_4)

    def _linkingR2_3(m,J,T):
        return m.varTime['R2',J] - sum(m.X[II,J,T]*m.tau_p[II,J]     for II in m.I_R2)<=4*(1-sum(m.X[II,J,T] for II in m.I_R2))
    m.linkingR2_3=pe.Constraint(m.J_reactors,m.T,rule=_linkingR2_3)

    def _linkingR2_4(m,J,T):
        return -(m.varTime['R2',J] - sum(m.X[II,J,T]*m.tau_p[II,J]     for II in m.I_R2))<=4*(1-sum(m.X[II,J,T] for II in m.I_R1))
    m.linkingR2_4=pe.Constraint(m.J_reactors,m.T,rule=_linkingR2_4)

    def _linkingR3_3(m,J,T):
        return m.varTime['R3',J] - sum(m.X[II,J,T]*m.tau_p[II,J]     for II in m.I_R3)<=4*(1-sum(m.X[II,J,T] for II in m.I_R3))
    m.linkingR3_3=pe.Constraint(m.J_reactors,m.T,rule=_linkingR3_3)

    def _linkingR3_4(m,J,T):
        return -(m.varTime['R3',J] - sum(m.X[II,J,T]*m.tau_p[II,J]     for II in m.I_R3))<=4*(1-sum(m.X[II,J,T] for II in m.I_R1))
    m.linkingR3_4=pe.Constraint(m.J_reactors,m.T,rule=_linkingR3_4)
    ...
    def _lastN(m,I,J):
        return math.floor((m.T.__len__()-1)/m.tau[I,J])
    ...
    def _C_TCP3(m):
        return m.TCP3== sum(sum(sum(m.X[I, J, T]*(m.hot_cost*m.Integral_hot['R1', J][m.N['R1', J].last()] + m.cold_cost*m.Integral_cold['R1', J][m.N['R1', J].last()]) for T in m.T) for I in m.I_R1)for J in m.J_reactors)+ sum(sum(sum(m.X[I, J, T]*(m.hot_cost*m.Integral_hot['R2', J][m.N['R2', J].last()] + m.cold_cost*m.Integral_cold['R2', J][m.N['R2', J].last()]) for T in m.T) for I in m.I_R2)for J in m.J_reactors)+sum(sum(sum(m.X[I, J, T]*(m.hot_cost*m.Integral_hot['R3', J][m.N['R3', J].last()] + m.cold_cost*m.Integral_cold['R3', J][m.N['R3', J].last()]) for T in m.T) for I in m.I_R3)for J in m.J_reactors)
...
def solve_scheduling_and_control(
        model_fun,
        solver,
        auxiliary_cuts,
        auxiliary_ctus_type,
    ...
    if solver=='GBD':
        ...
        sub.linkingR1_1.deactivate()
        sub.linkingR1_2.deactivate()
        sub.linkingR2_1.deactivate()
        sub.linkingR2_2.deactivate()
        sub.linkingR3_1.deactivate()
        sub.linkingR3_2.deactivate()
        sub.linkingR1_3.deactivate()
        sub.linkingR1_4.deactivate()
        sub.linkingR2_3.deactivate()
        sub.linkingR2_4.deactivate()
        sub.linkingR3_3.deactivate()
        sub.linkingR3_4.deactivate()
        ...
        #####------------------Heuristic cuts -------------------------######################
        # Auxiliary feasibility subproblem 1: minimum processing times
        mint=sub.clone()
        ...
        # Auxiliary feasibility subproblem 2: maximum capacity
        maxb=sub.clone()
        maxb.obj_dyn.deactivate()
        def _obj_b(m):
            return sum(sum( -maxb.Vreactor[I,J] for I in maxb.I_reactions) for J in maxb.J_reactors)
        maxb.obj_b = pe.Objective(rule=_obj_b, sense=pe.minimize)  

        #Initial cuts
        for I in mint.I:
            for J in mint.J:
                if initial_cuts ==3 and I in mint.I_reactions and J in mint.J_reactors:
        ...
        for I_J in mint.I_J:
                ...
                J=I_J[1]
                mint.Nref[I,J].fix(1) 
        if initial_cuts ==2 or initial_cuts ==3:
        ...
        if not initialize_with_master:
            if relaxed:
                relm=model_fun(**kwargs2)
                relm.X.domain=pe.NonNegativeReals
                relm.Nref.domain=pe.NonNegativeReals

                relm=solve_subproblem(relm,subproblem_solver=nlp_solver,subproblem_solver_options = sub_options,timelimit = 86400, gams_output = False,tee = False,rel_tol = 0)
        ...
        #3: Solve primal problem
            ...
            if sub.dsda_status=='Optimal':
                ...
                if auxiliary_cuts:
                    # Improved feasibility cuts of type 1
                    if auxiliary_ctus_type=='mint' or auxiliary_ctus_type=='all': 
                    ...
                    # Improved feasibility cuts of type 2
                    if auxiliary_ctus_type=='maxb' or auxiliary_ctus_type=='all': 
                        for I in maxb.I_reactions:
                            for J in maxb.J_reactors:
                        
                                if pe.value(mas.varTime[I,J])>=mas.varTime[I,J].ub: 
                                    maxb.link_varTime[I,J].fix(mas.varTime[I,J].ub)
                                elif pe.value(mas.varTime[I,J])<=mas.varTime[I,J].lb:
                                    maxb.link_varTime[I,J].fix(mas.varTime[I,J].lb)
                                else:
                                    maxb.link_varTime[I,J].fix(pe.value(mas.varTime[I,J]))
                        maxb=solve_subproblem(maxb,subproblem_solver=nlp_solver,subproblem_solver_options = sub_options,timelimit = 86400, gams_output = False,tee = False,rel_tol = 0) 
                        
                    
                    if auxiliary_ctus_type=='all' and mint.dsda_status=='Optimal' and maxb.dsda_status=='Optimal':
                        for I in mint.I_reactions:
                            for J in mint.J_reactors:
