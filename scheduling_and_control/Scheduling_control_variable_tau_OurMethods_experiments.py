...
<<<<<<< HEAD
    sub_options={'add_options':['GAMS_MODEL.optfile = 0;','GAMS_MODEL.threads = 0;']}
    initialization=feas_init
    infinity_val=1e+3 #TODO: DBD FROM FEASIBLE WORKED VERY WELL WITH 1E+4. I HAVE TO USE DIFFFERENT INFINITY VALUES DEPENDING ON STAGE 1 2 OR 3. I have scaled objective in phase 2
=======
<<<<<<< HEAD
    sub_options={'add_options':['GAMS_MODEL.optfile = 0;'+'\n','GAMS_MODEL.threads = 0;']}
    initialization=feas_init
    infinity_val=1e+4 #TODO: DBD FROM FEASIBLE WORKED VERY WELL WITH 1E+4. I HAVE TO USE DIFFFERENT INFINITY VALUES DEPENDING ON STAGE 1 2 OR 3. I have scaled objective in phase 2
>>>>>>> cfcdfac15a55487955d5a962fcfd13c7ee99b01b
    maxiter=10000
    neigh=neighborhood_k_eq_2(len(initialization))
    model_fun =scheduling_and_control_GDP_complete_approx
...
>>>>>>> cfcdfac15a55487955d5a962fcfd13c7ee99b01b
    ...
    textbuffer.write('\n Objective: \n') 
    textbuffer.write(str(pe.value(m.obj)))    
    with open('Results_variable_tau_enhanced_dbd_aprox_k_2_increased_horizon28_lab3.txt', 'w') as outputfile:
        outputfile.write(textbuffer.getvalue())
    ...
    textbuffer.write('\n Objective: \n') 
    textbuffer.write(str(pe.value(m.obj)))    
    with open('Results_variable_tau_enhanced_dbd_aprox_k_2_increased_horizon_from_infeasible28.txt', 'w') as outputfile:
        outputfile.write(textbuffer.getvalue())
