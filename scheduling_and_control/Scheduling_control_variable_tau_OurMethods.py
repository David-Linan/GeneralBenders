...
## --------------------NEW tests, increasing or decreasing scheduling horizon-------------------------------------------------------
    ...
    model_fun=scheduling_only_gdp_N_solvegdp_simpler_lower_bound_tau
    m=model_fun(**kwargs)
    m_scheduling = solve_with_minlp(m,transformation='hull',minlp=mip_solver,minlp_options=sub_options_infeas_init,timelimit=3600000,gams_output=True,tee=True,rel_tol=0.02)
