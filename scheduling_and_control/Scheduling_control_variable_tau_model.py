...
#TODO: BE CAREFUL WHEN USING THIS ONE, IT HAS NOT BEEN UPDATED!!!!!!!!!!!!!!!!
...
#     # m.Nref[('Mix', 'Mix')].fix(1)
#     # m.Nref[('Pack1', 'Pack')].fix(2) 
#     # m.Nref[('Pack2', 'Pack')].fix(1)
#     # m.Nref[('R1', 'R_large')].fix(2) 
#     # m.Nref[('R1', 'R_small')].fix(2)
#     # m.Nref[('R2', 'R_large')].fix(2)
#     # m.Nref[('R2', 'R_small')].fix(2)
#     # m.Nref[('R3', 'R_large')].fix(1)
#     # m.Nref[('R3', 'R_small')].fix(1)
#     # m.Nref[('Sep', 'Sep')].fix(1)
...
if __name__ == "__main__":
    ...
    # m.Y.pprint()
    # m.tau.pprint()
    m=scheduling_and_control_gdp_N()