...
def build_fermentation_convergence_test1(discretization: str='collocation',n_f_elements_t: int=10) -> pe.ConcreteModel():
    ...
    _C_elect_init_param['CO2aq']=0.01*m.rho_soluble_kg_L*(1/m.MW_elect['CO2aq'])
    _C_elect_init_param['C4H6O4']=0.01* m.rho_soluble_kg_L*(1/m.MW_elect['C4H6O4'])   #Succinic acid
    _C_elect_init_param['C3H6O3']=0.01* m.rho_soluble_kg_L*(1/m.MW_elect['C3H6O3'])  #Lactic acid
...
# def build_fermentation_convergence_test_final(discretization: str='collocation',n_f_elements_t: int=10) -> pe.ConcreteModel():
