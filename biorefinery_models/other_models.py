...
def build_fermentation_convergence_test2(discretization: str='collocation',n_f_elements_t: int=10, conv_param: float=0) -> pe.ConcreteModel():
...
def build_fermentation_convergence_test3(discretization: str='collocation',n_f_elements_t: int=10, conv_param: float=0) -> pe.ConcreteModel():
...
def build_fermentation_convergence_testFinal2(discretization: str='collocation',n_f_elements_t: int=10, conv_param: float=0) -> pe.ConcreteModel():
...
def build_fermentation_convergence_testFinal3(discretization: str='collocation',n_f_elements_t: int=10, conv_param: float=0) -> pe.ConcreteModel():
...
def build_fermentation_convergence_testFinal4(discretization: str='collocation',n_f_elements_t: int=10, conv_param: float=0) -> pe.ConcreteModel():
    ...
    def _r2_definition(m,t):
        K2_r2=0.036#0.0023 #changed         # reaction rate constant, kg/(g*s)
        IC2_r2=132          # Inhibition of r2 by cellobiose, g/kg
        IX2_r2=0.029           # Inhibition of r2 by xylose, g/kg
        IG2_r2=0.34          # Inhibition of r2 by glucose, g/kg
        IF2_r2=10          #  Inhibition of r2 by furfural, g/kg
    ...
    def _r4_definition(m,t):
        K4_r4=0.87#0.0087#0.0027     # reaction rate constant, kg/(g*s)
        IC4_r4= 24.3         # Inhibition of r4 by cellobiose, g/kg
        IX4_r4= 201         # Inhibition of r4 by xylose, g/kg 
        IG4_r4= 2.34         # Inhibition of r4 by glucose, g/kg
        IF4_r4= 10         #  Inhibition of r4 by furfural, g/kg
...
#     #     plt.show()
    ...
    # plt.show()
    for j in m.j:
        if j=='G' or j=='X' or j=='Eth' or j=='Cell' or j=='AC':
            plt.plot(time,vec[j],label=j)
        # original = pd.read_csv('biorefinery_models/ph_hydrolisis.csv', header=None)
        # plt.plot(original.iloc[:, 0].values, original.iloc[:, 1].values,'--k')
        plt.xlabel('time [-]')
