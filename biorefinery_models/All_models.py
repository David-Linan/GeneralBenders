...
if __name__ == '__main__':
    ...
    if v3=='FERMENTATION':
        ...
        m=build_fermentation(discretization=discretization_type_fer,n_f_elements_t=finite_elem_t_fer)
        m=initialize_model(m,from_feasible=True,feasible_model='validation_fermentation_init')
        opt1 = SolverFactory('gams')
        results = opt1.solve(m, solver=solver, tee=True)
        generate_initialization(m=m,model_name='validation_fermentation')
