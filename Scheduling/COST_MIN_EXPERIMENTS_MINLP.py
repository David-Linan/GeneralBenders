...
from functions.d_bd_functions import run_function_dbd,run_function_dbd_scheduling_cost_min_nonlinear
...
if __name__ == "__main__":
    ...
    [important_info,D,x_actual]=run_function_dbd_scheduling_cost_min_nonlinear(model_fun_feasibility,lower_obj,min_epsilon_improvement,initialization,infinity_val,nlp_solver,neigh,maxiter,ext_ref,logic_fun,model_fun_simplified,kwargs,use_random=False,sub_solver_opt={}, tee=True)
