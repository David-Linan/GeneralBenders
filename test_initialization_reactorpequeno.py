...
if __name__ == "__main__":
    ...
    size_of_batches=10
    initial_sampled_points=26
    max_number_sampled_points=28
    value_slightly_greater_than_global_opt=3.08
    tolerance=0.01
    number_of_iter_where_probability_must_remain_constant=10
    ...
    a_file = open("test_probabilities_more_rigurous2_26_to_28.pkl", "wb")
    pickle.dump(probability_data, a_file)
    a_file.close()

    a_file = open("test_probabilities_secondary_info_more_rigurous2_26_to_28.pkl", "wb")
